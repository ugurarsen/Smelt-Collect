...
public class Stage1Demo : MonoBehaviour
{
    #region --- Inspector ---
    ...
    {
        SupersonicWisdom.Api.NotifyLevelCompleted(_currentLevel, null);
    ...
    {
        SupersonicWisdom.Api.NotifyLevelFailed(_currentLevel, null);

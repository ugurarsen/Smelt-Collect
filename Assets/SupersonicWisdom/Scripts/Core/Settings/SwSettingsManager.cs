...
namespace SupersonicWisdomSDK
{
    internal class SwSettingsManager<T> where T : class, ISwSettings
    {
        ...
        private readonly ISwKeyValueStore _keyValueStore;
        ...
        public SwSettingsManager(ISwKeyValueStore keyValueStore, string resourcePath = SwConstants.SettingsResourcePath)
        {
